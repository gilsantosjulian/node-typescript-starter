...
router.get('/all', (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    try {
        const response = yield controllers_1.default.vendorsController.getAll();
        res.status(200).send({
            code: 200,
            status: 'success',
            message: null,
...
router.get('/:id', (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        const response = yield controllers_1.default.vendorsController.getOne(id);
        res.status(200).send({
            code: 200,
            status: 'success',
            message: null,
